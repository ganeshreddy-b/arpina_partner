package com.sanjay.androidamcservice.chat.service;
...
import com.sanjay.androidamcservice.utils.AppSettings;
...
import static com.sanjay.androidamcservice.app.Constants.ACTION_LOGGED_IN;
import static com.sanjay.androidamcservice.app.Constants.HOST;
import static com.sanjay.androidamcservice.app.Constants.PORT;
...
public class XMPP {
    ...
    private XMPPTCPConnectionConfiguration buildConfiguration() throws XmppStringprepException {
        ...
        try {
            builder.setHostAddress(InetAddress.getByName("10.0.2.2"));
        } catch (UnknownHostException e) {
            e.printStackTrace();
        }
//        builder.setXmppDomain(JidCreate.domainBareFrom("localhost"));
