...
public class ChatActivity extends AppCompatActivity {
    ...
    LinearLayout layout;
    boolean exit = false;
    public static final String APP_ID = Constants.KOMMUNICATE_APP_ID;
...
//        txtViewPrivacyPolicy.setMovementMethod(LinkMovementMethod.getInstance());
        ...
        progressDialog.show();
        initLoginData(appSharedPreference.getEmailKey(), "admin",appSharedPreference.getPhoneKey(), progressDialog);
...
//        });
    ...
    public void initLoginData(String userId, String password,String phoneNumber ,final ProgressDialog progressDialog) {
